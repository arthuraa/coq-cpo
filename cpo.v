...
Definition pack :=
  [find tc | @TermCat.hom tc ~ C1 | "not a termCatType" ]
  [find tb | TermCat.class tc ~ tb ]
  [find pc | @ProdCat.hom pc ~ C1 | "not a prodCatType" ]
...
Proof.
split; last by move=> ->.
by move=> H; apply: retr_retr_inj; apply: eq_cont H.
Qed.
